    ...
    <div class="row">
          ...
          <div class="row">
            <div class="col-md-5 pe-md-1">
                ...
                <div class="row">
                  <div class="col-6">
                    ...
                    <div class="item">
                      ...
                      <p class="m-0 font-14">{{rent_info.available_from}}</p>
                    </div>
                    <div class="item">
                      <div>
                  ...
                  <div class="col-6">
                    ...
                    <div class="item">
                        <div class="img">
                          <img src="/images/Rent-details-icon/For Student &.svg">
                        </div>
                        <p class="m-0 font-14">For
                          <span v-if="for_rent.male_student && for_rent.female_student && for_rent.man_job && for_rent.women_job">Student & Job Holder</span>

                          <span v-else-if="for_rent.male_student && for_rent.female_student">Student</span>

                          <span v-else-if="for_rent.male_student">Male Student</span>
                          <span v-else-if="for_rent.female_student">Female student</span>
                          <span v-else-if="for_rent.man_job && for_rent.women_job">Job Holder</span>
                          <span v-else-if="for_rent.man_job">Male Job Holder</span>
                          <span v-else-if="for_rent.women_job">Female Job Holder</span>
              ...
              <div class="Other mt-2">
                ...
                <div class="row">
                  <div class="col-6">
                    <div class="item">
                      <div>
                      <img src="/images/Rent-details-icon/Other-charges/Electricity Bill.svg">
                      </div>
                      <span class="m-0 font-14">{{symbol}}{{charges.electric}} Electricity Bill</span>
                    </div>
                    <div class="item">
                      <div>
                      <img src="/images/Rent-details-icon/Other-charges/Gas Bill.svg">
                      </div>
                      <span class="m-0 font-14">{{symbol}}{{charges.gas}} Gas Bill</span>
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="item">
                      <div>
                      <img src="/images/Rent-details-icon/Other-charges/Water Bill.svg">
                      </div>
                      <span class="m-0 font-14">{{symbol}}{{charges.water}} Water Bill</span>
                    </div>
                    <div class="item">
                      <div>
                      <img src="/images/Rent-details-icon/Other-charges/Service.svg">
                      </div>
                      <span class="m-0 font-14">{{symbol}}{{charges.service}} Service Charge</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="other-benifit">
                ...
                <div class="benefit" :class="benefits.lift ? '' : 'error'" v-b-popover.hover.top="'Lift'">
                ...
                <div class="benefit" :class="benefits.generator ? '' : 'error'" v-b-popover.hover.top="'Generator'">
                ...
                <div class="benefit" :class="benefits.gas ? '' : 'error'" v-b-popover.hover.top="'Gas-service'">
                ...
                <div class="benefit" :class="benefits.parking ? '' : 'error'" v-b-popover.hover.top="'Parking'">
                ...
                <div class="benefit" :class="benefits.guard ? '' : 'error'" v-b-popover.hover.top="'Security gurd.'">
                ...
                <div class="benefit" :class="benefits.internet ? '' : 'error'" v-b-popover.hover.top="'WIFI'">
      ...
      <div class="col-lg-3">
        <div class="card card-body rounded-0 border-0 h-100">
          ...
          <h3 class="rent-title text-green">{{symbol}}{{charges.rent_price}}/Month</h3>
            ...
            <div class="auth d-flex mt-2">
              ...
              <div class="info ms-2">
                ...
                <p class="font-14 text-gray">
                  <span v-if="!loader && !phoneNumberShow">{{ user.contact.substring(0, 5) }}XXXXXX</span>
                  <span v-if="!loader && phoneNumberShow">{{ user.contact }}</span>
                  </p>
              </div>
            </div>
            <div class="number-btn text-center mt-2">
            <button class="btn btn-primary font-14 w-100" @click="toggleContact">
...
export default {
  ...
  methods: {
    rentDetails() {
      ...
      this.$store.dispatch("rent/rentDetails", this.$route.params.id)
        .then(res => {
